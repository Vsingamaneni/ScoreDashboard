    ...
    <div class="w3-bar-block">
        ...
        <c:if test="${ not user_name.equalsIgnoreCase('user')}">
            ...
            <c:if test="${role.equalsIgnoreCase('admin')}">
                ...
                <a href="/results" class="w3-bar-item w3-button w3-padding"><i class="fa fa-legal"></i>&nbsp; Admin</a>
                    ...
                    <c:if test="${not empty resultList}">
                        <c:forEach var="result" items="${resultList}">
                            <tr style="color:black;font-size:20px;text-decoration:none;font-family:Comic Sans MS">
                                <td style="text-align:left;"> ${result.matchNumber}</td>
                                <td style="text-align:left;"> ${fn:toUpperCase(result.homeTeam)}</td>
                                <td style="text-align:left;"> ${fn:toUpperCase(result.awayTeam)}</td>
                                <td style="text-align:left;">${result.startDate}</td>
                                <td style="text-align:left;">${result.winner}</td>
                                <td style="text-align:left;">${result.adminAmount}</td>
                                <td style="text-align:left;">${result.net}</td>
                            </tr>
                        </c:forEach>
                    </c:if>
                </table>
